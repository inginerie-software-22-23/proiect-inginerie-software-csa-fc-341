...
import { Export_To_PDF } from "./Export_PDF_Players";
...
export function ExportExcel(date_export){
    ...
    date_export.date_export.forEach(e=>{
        var aux = {
            ...
            Picior: e["picior"],
            Pozitie: e["pozitie"],
            Nationalitate: e["nationalitate"],
            Inaltime: e["inaltime"],
            Data_Nastere: e["data_nastere"]
        }
    ...
    return(
        <div className="export">
            <button>
                <CSVLink data = {sorted_date_export} filename="exported_players" className="buton" style={{color: "white", textDecoration: 'none'}}>Export to Excel</CSVLink>
            </button>
